...
var config = {
 ...
 firebase.initializeApp(config);
    ...
    <script type="text/javascript">
        ...
        // dosages tables
        var dosagesTable = db.ref('Questions/');

        // user's dosage table will be stored here
        var userDosages = dosagesTable.child(user + '_question');
                    ...
                    <div class="mega-menu col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <nav id="menuzord" class="menuzord menuzord-responsive">
                            <ul class="menuzord-menu">
                                ...
                                <li><a href="#patient">My Students</a>
                                    <!-- <ul class="dropdown">
...
<Section>
 ...
 -->
      ...
      //caonnect with database
          ...
          //Refer Patient table to fetch assigned patient's table
                        var userRef = database.ref().child("Questions");


                       userRef
                       //Grab the  username where caretaker name is current loggedin user
                       .orderByChild("username")
                       .startAt(username) .endAt(username)
                       .on("value",function(snapshot){
                        //Count No of  who assigned for the particular caretaker
                        var count=0;
                        //Iterate snapshot elements and increase count
                         snapshot.forEach(function() {
                          count++;
                              ...
                              //To print questions
                              var patientRef2=database.ref().child("Questions");
                               ...
                               .on("child_added",function(snapshot){
                                 ...
                                 //  v.appendChild(t);
                                  ...
                                  //Give onclick function as myFunction()
                                       ...
                                       // }
                                       //Firstname text                                 
                                  var firstnametxt=document.createTextNode("Question:");
                                  
                                  //Patients firstname
                                  var firstname=document.createTextNode(snapshot.val().question);
                                  //Create break tags
 ...
 <!-- Create button to return caretaker page -->
            <input type="button" class="commonButton" value="Back To My Profile"
                   onclick="document.location.href='caretakerHomePage.php'" style="margin-left:210px">

    </div>
    </div>
    <div class="right" id="schedules">

        <center><h1><b>Student <span style="color:#19baaa">Stats</span></b></h1></center>
