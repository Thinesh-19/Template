...
<section class="picture" style="height:250px">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <br><br>
                        <h1 class="whiteColor"><b>Add Hospital</b></h1><h2 class="title"><b>Be a part of our community</b></h2>
            ...
            <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <!-- <div class="panel panel-info"> -->
                    ...
                    <div style="padding-top:30px" class="panel-body">
                      ...
                      <form method="POST" name="step2" action="addMoreSchedule.php">
      <br/><br/>
      <img src="images/hospital.png" style="width:200px;margin-left:200px;margin-top:-100px">
...
<input type="submit" class="commonButton" name="commonButton" id="commonButton" value="addMoreHospitals" style="margin-left :100px;margin-top:-35px">

</form>

  
<input type="button" class="commonButton" name="commonButton" id="commonButton" value="Finish" style="margin-left:350px;margin-top:-43px;" onclick="document.location.href='doctorHomePage.php'">
