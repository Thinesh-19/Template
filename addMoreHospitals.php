            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <br><br>
                        ...
                        <h3 class="title"> <span class="whiteColor"><b>Step 3 : </b></span><b>Insert Your Hospital Details</b> </h3>
                    </div>
                </div>
            </div>
        </section>
...
<section>
    ...
    <div class="sub-page-content">
        <div class="container">
            ...
            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="text" class="form-control" name="hospitalAddress" id="hospitalAddress" value="" placeholder="Enter Your Address" required />
                            </div>
            ...
            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="number" class="form-control" name="telephoneNumber" id="telephoneNumber" value="" placeholder="Enter Your Telephone No" required />
                            </div>
