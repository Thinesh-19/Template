...
$userName = $_SESSION['session1'];
//@$addMore = $_GET["addMore"];
//echo"<input type=hidden name=hiddenSession id= value=$_SESSION[session1]>";
echo"<input type=hidden name=hiddenSession id=hiddenSession value=$userName>";
 ...
 <script src="https://www.gstatic.com/firebasejs/4.0.0/firebase.js"></script>
    <script>
        ...
        function writeDoctorHospitalData(p_address, p_name, p_telno, p_username, p_visitingTime) {
            ...
            // redirect
            window.location = "scheduleConfirmation.php?doctorUsername=" + p_username;
    ...
    <div class="sub-page-content">
        <div class="container">
            ...
            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input type="text" class="form-control" name="hospitalName" id="hospitalName" value="" placeholder="Enter Your Hospital Name" required />
                            </div>
            ...
            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="text" class="form-control" name="hospitalAddress" id="hospitalAddress" value="" placeholder="Enter Your Hospital Address" required />
                            </div>
            ...
            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="number" min="0" max=24 class="inputs" name="visitingHour" style="width:240px" id="visitingHour" size="30"
                   placeholder="Hours"  required>

            <input type="number" min="0" max=60 class="inputs" name="visitingMin" id="visitingMin" size="30"
                   placeholder="Minutes" style="width:240px" required>
            <br/>
                            </div>
        ...
        if(isset($addMore)){
            ...
            echo "<input type=button class=commonButton name=signUpBtn id=signUpBtn onclick=submitDoctorHospitalData() value='Add Hospital'
