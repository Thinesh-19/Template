                        ...
                        <div class="header-widget">
                        	<div class="iconbox-widget">
                        		...
                        		<div class="box-contenet">
                        			...
                        			<p class="sub-title"><a href="login.php">If you have account</a></p>
                        		</div>
                        	</div>
                        	<div class="iconbox-widget">
                        		<div class="icon">
			...
			<div class="container">
				...
				<div class="row">
					...
					<br><br>
						...
						<h3 class="title"> <span class="whiteColor"><b>Step 1 : </b></span><b>Insert Your Details</b> </h3>
					...
					<div style="padding-top:30px" class="panel-body">
						...
						<form method="POST" name="step1" action="connectionAction.php">
							...
							<div style="margin-bottom: 25px" class="input-group">
								...
								<input id="first_name" type="text" class="form-control" name="firstName" id="firstName" value="" placeholder="Enter First Name" required />
							</div>

							<label for="lastname" class="input-label">Last Name</label>
							<div style="margin-bottom: 25px" class="input-group">
								<span class="input-group-addon"></span>
								<input id="last_name" type="text" class="form-control" name="lastName" id="lastName" value="" placeholder="Enter Last Name" required />
							</div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input id="email" type="email" class="form-control" name="email" id="email" size="30" value="" placeholder="Eg: jane.20@gmail.com" required />
                            </div>
