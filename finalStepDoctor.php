            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <br><br>
                        ...
                        <h3 class="title"> <span class="whiteColor"><b>Step:4</b></span><b>Please Select Your Patients</b> </h3>
                    </div>
                </div>
            </div>
        </section>
                ...
                <!-- <div class="panel panel-info"> -->
                    ...
                    <div style="padding-top:30px" class="panel-body">
                        ...
                        <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                         ...
                         <img src="images/patient-icon.png" alt="caretaker" style="margin-left:150px;margin-top:-100px">
                         <br/><br/>
                         <label for="caretaker" class="input-label" style="margin-left:150px">Choose your patients</label><br/>
 <!--to display patient selection box ///////////////////////////////////////-->
        <div id="patientSelection" style="margin-left:150px"></div>
