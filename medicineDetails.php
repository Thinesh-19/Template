  ...
  <script src="https://www.gstatic.com/firebasejs/4.0.0/firebase.js"></script>
    <script>
        ...
        function submitMedicineData() {
            ...
            var md_amount=document.getElementById('amount').value;


            // write data to database
            writeMedicineData(md_bottleId, md_dosageGap, md_medicine, md_patient,md_amount);
            //write(md_patient);
           // write(md_amount,md_bottleId,md_medicine,md_patient);
        ...
        function writeMedicineData(p_bottleId, p_dosageGap, p_medicine, p_patient,p_amount) {
            ...
            updates['/bottles/' + p_bottleId] = bottleObj;
             updates['/notifications/' + p_patient + '_notifications'] = patientDosageObj;


            firebase.database().ref().update(updates);
            // var update1={};
            
            // update1['/notifications/'+p_patient+"_notifications"];
            // firebase.database().ref().update(update1);

            // redirect
            window.location = "medicalConfig.php?patient=" + p_patient + "&medicine=" + p_medicine + "&dosageGap=" + p_dosageGap + "&bottleId=" + p_bottleId+"&amount=" +p_amount;
                        ...
                        <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                         ...
                         <form method="POST" name="careTakerSelectForm">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input type="text" class="form-control" name="medicine" id="medicine" value="" placeholder="Enter Medicine Name" required />
                            </div>
                           ...
                           placeholder="Amount"  required>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"></span>
                                <input type="number" class="form-control" name="bottleId" id="bottleId" placeholder="Eg:1" required />
                            </div>
                            <!--  <?php
...
<input type="button" style="margin-left:250px" class="commonButton" name="nextStep" id="nextStep" value="Signup"
